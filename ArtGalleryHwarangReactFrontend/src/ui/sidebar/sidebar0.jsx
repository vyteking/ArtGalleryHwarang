...
function Sidebar0() {
    ...
    return <div id="sidebar0" className={getClassNames("layout")}>
        <ul id="menulist" className={getClassNames("")}>
            <Link to="/"><li className={getClassNames("menuitem")}>mainpage</li></Link>
            <Link to="/hot"><li className={getClassNames("menuitem")}>hot</li></Link>
            <Link to="/u/random"><li className={getClassNames("menuitem")}>random_user_page</li></Link>
            <Link to="/p/random"><li className={getClassNames("menuitem")}>random_submission</li></Link> 
