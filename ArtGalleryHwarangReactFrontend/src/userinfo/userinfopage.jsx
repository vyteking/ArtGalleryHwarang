        ...
        <form id="Userinfopage" class="layout">
            ...
            <table id="UserInfoTable" class="layout">
                <tr class="userinfotable">
                    ...
                    <td class="userinfotable"><input id="tbx_UserIdx1st_Placeholder" class="userinfotable" type="text" placeholder={langTxt.userindex1st}/></td>
                </tr>
                <tr class="UserInfoTable">
                    <td class="userinfotable"><label id="lbl_UserID" class="userinfotable" for="tbx_UserID">{langTxt.userID}</label></td>
                    <td class="userinfotable"><input id="tbx_UserId_Placeholder" class="userinfotable" type="text" placeholder={langTxt.userID}/></td>
                </tr>
            </table>
            </table>
        </form>
