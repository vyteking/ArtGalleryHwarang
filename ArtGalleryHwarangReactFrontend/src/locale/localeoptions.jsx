...
import localeloader from './locale/localetextfiles/en.json' //English as temporarily
...
const LoadLocaleList = (r) => {
    let files = {};
    let localefolderpath = './locale/localetextfiles/';
    r.Keys().forEach((itm) => {})
}

function SetLocale(selectedLocale) {
    let localefilepath = './locale/localetextfiles/'+selectedLocale+".json";
